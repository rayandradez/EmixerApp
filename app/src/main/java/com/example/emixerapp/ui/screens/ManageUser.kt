    ...
    override fun onCreateView(
        ...
        adapter.onItemClick = { position ->
            ...
            val action = if (selectedUser != null) {
                ManageUserDirections.actionManageUserToAddUser(selectedUser)
            } else {
                ManageUserDirections.actionManageUserToAddUser(null)
            }
        ...
        binding.addNewUserButton.setOnClickListener {
            findNavController().navigate(R.id.action_manageUser_to_addUser)
        }
