package com.reaj.emixer.data.model
...
/**
 * Classe de dados representando um usuário no aplicativo. Implementa Parcelable para passagem eficiente de dados
 * entre componentes Android.  Parcelable usa Parcel para serializar e desserializar objetos,
 * permitindo que eles sejam passados através de Intents e salvos no estado do sistema,
 * tornando a comunicação entre componentes mais eficiente.
 */
data class UserModel(
    val id: String = UUID.randomUUID().toString(), // Identificador único para o usuário. Gerado automaticamente se não fornecido.
    ...
    /**
     * Construtor usado para criar um UserModel a partir de um Parcel. Necessário para a implementação de Parcelable.
     */
    constructor(parcel: Parcel) : this(
        UUID.fromString(parcel.readString()).toString(), // Lê o ID do Parcel.
    ...
    /**
     * Escreve o conteúdo deste UserModel em um Parcel. Necessário para a implementação de Parcelable.
     */
    ...
    /**
     * Descreve o conteúdo deste UserModel. Necessário para a implementação de Parcelable. Retorna 0 para simplificar.
     */
     ...
     * serializados em um Parcel, por exemplo, quando uma Activity é recriada após uma rotação de tela.
     */
